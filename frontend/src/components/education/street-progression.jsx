...
const STREETS = [
    { name: 'Preflop', boardCount: 0, description: 'Hole cards are dealt. The first betting round.' },
    { name: 'Flop', boardCount: 3, description: 'The first 3 community cards are revealed at once.' },
 ...
 */
const UndealtSlot = () => <div className="h-14 w-10 rounded-lg border border-dashed border-muted-foreground/40" />
